...
public class Main { //main class
    ...
    static boolean print = true; //boolean for formatting
    public static void main(String[] args) { //main method
        ...
        if (args.length > 0) {
            ArrayList<String> userin = new ArrayList<>(Arrays.asList(args));
            print = userin.get(0).equalsIgnoreCase("true");
    ...
    public static ArrayList<String> correct(ArrayList<String> words, String item) {
        if (print) {
            if (!(check(words, item))) { //checks if the word is in the dictionary
                ...
                if (similar.size() == 0) {
                    System.out.println();
                } //prints a new line if there are no similar words
